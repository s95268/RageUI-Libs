...
---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "commonmenu.ytd", Texture = "arrowleft", X = 378, Y = 5, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "commonmenu.ytd", Texture = "arrowright", X = 400, Y = 5, Width = 25, Height = 25 },
    Text = { X = 405, Y = 7, Scale = 0.25 },
}
